  ...
  return (
    <header className="w-full px-4 py-3 flex items-center justify-between border-b border-white/10">
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <div className="text-white font-bold leading-none text-sm">Base Minesweeper</div>
          <div className="text-white/40 text-xs leading-none mt-0.5">Onchain · Provably Fair</div>
        </div>
      </div>
      <ConnectButton
        showBalance={false}
